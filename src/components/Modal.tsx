                            ...
                            >
                                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6" >
                                    ...
                                    <div className='mt-5 flex justify-between gap-4'>
                                        <button
                                            className='w-full bg-gray-600 p-3 font-bold uppercase text shadow hover:bg-gray-500'
                                            onClick={closeModal}
                                        >Cerrar</button>

                                        <button
                                            className='w-full bg-orange-600 p-3 font-bold uppercase text shadow hover:bg-orange-500'
                                            onClick={() => {
